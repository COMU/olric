...
# Generated by qmake (2.01a) (Qt 4.4.3) on: Per Mar 19 21:04:28 2009
# Project:  olric.pro
# Template: app
...
INCPATH       = -I/usr/qt/4/mkspecs/linux-g++ -I. -I/usr/qt/4/include/QtCore -I/usr/qt/4/include/QtCore -I/usr/qt/4/include/QtNetwork -I/usr/qt/4/include/QtNetwork -I/usr/qt/4/include/QtGui -I/usr/qt/4/include/QtGui -I/usr/qt/4/include/QtXml -I/usr/qt/4/include/QtXml -I/usr/qt/4/include -I. -Isrc -Ibuild -Ibuild
LINK          = g++
...
$(TARGET): build/ui_anapencere.h build/ui_about.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/olric1.0.0/ && $(COPY_FILE) --parents src/AnaPencere.h src/client.h src/tool.h about.h build/olric1.0.0/ && $(COPY_FILE) --parents resources/source.qrc build/olric1.0.0/ && $(COPY_FILE) --parents qtc-gdbmacros/gdbmacros.cpp src/AnaPencere.cpp src/client.cpp src/main.cpp src/tool.cpp build/olric1.0.0/ && $(COPY_FILE) --parents ui/anapencere.ui about.ui build/olric1.0.0/ && $(COPY_FILE) --parents resources/olric_tr_TR.ts build/olric1.0.0/ && (cd `dirname build/olric1.0.0` && $(TAR) olric1.0.0.tar olric1.0.0 && $(COMPRESS) olric1.0.0.tar) && $(MOVE) `dirname build/olric1.0.0`/olric1.0.0.tar.gz . && $(DEL_FILE) -r build/olric1.0.0
...
compiler_moc_header_make_all: build/moc_AnaPencere.cpp build/moc_about.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) build/moc_AnaPencere.cpp build/moc_about.cpp
...
build/moc_about.cpp: build/ui_about.h \
		about.h
	/usr/qt/4/bin/moc $(DEFINES) $(INCPATH) about.h -o build/moc_about.cpp
...
compiler_uic_make_all: build/ui_anapencere.h build/ui_about.h
compiler_uic_clean:
	-$(DEL_FILE) build/ui_anapencere.h build/ui_about.h
build/ui_anapencere.h: ui/anapencere.ui
	/usr/qt/4/bin/uic ui/anapencere.ui -o build/ui_anapencere.h

build/ui_about.h: about.ui
	/usr/qt/4/bin/uic about.ui -o build/ui_about.h
