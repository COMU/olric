...
# Generated by qmake (2.01a) (Qt 4.4.1) on: Sal Eki 21 18:51:12 2008
# Project:  olric.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/olric1.0.0/ && $(COPY_FILE) --parents AnaPencere.h burn.h client.h pencereclient.h .tmp/olric1.0.0/ && $(COPY_FILE) --parents simgeler.qrc .tmp/olric1.0.0/ && $(COPY_FILE) --parents AnaPencere.cpp main.cpp pencereclient.cpp .tmp/olric1.0.0/ && $(COPY_FILE) --parents olric_en.ts .tmp/olric1.0.0/ && (cd `dirname .tmp/olric1.0.0` && $(TAR) olric1.0.0.tar olric1.0.0 && $(COMPRESS) olric1.0.0.tar) && $(MOVE) `dirname .tmp/olric1.0.0`/olric1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/olric1.0.0
...
compiler_moc_header_make_all: moc_AnaPencere.cpp moc_burn.cpp moc_pencereclient.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_AnaPencere.cpp moc_burn.cpp moc_pencereclient.cpp
moc_AnaPencere.cpp: AnaPencere.h
	/usr/qt/4/bin/moc $(DEFINES) $(INCPATH) AnaPencere.h -o moc_AnaPencere.cpp

moc_burn.cpp: burn.h
	/usr/qt/4/bin/moc $(DEFINES) $(INCPATH) burn.h -o moc_burn.cpp
