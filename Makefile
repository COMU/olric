...
# Generated by qmake (2.01a) (Qt 4.4.1) on: Cmt Kas 8 08:21:43 2008
# Project:  olric.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/olric1.0.0/ && $(COPY_FILE) --parents AnaPencere.h client.h pencereclient.h .tmp/olric1.0.0/ && $(COPY_FILE) --parents simgeler.qrc .tmp/olric1.0.0/ && $(COPY_FILE) --parents AnaPencere.cpp main.cpp pencereclient.cpp .tmp/olric1.0.0/ && $(COPY_FILE) --parents translations/olric_en.ts .tmp/olric1.0.0/ && (cd `dirname .tmp/olric1.0.0` && $(TAR) olric1.0.0.tar olric1.0.0 && $(COMPRESS) olric1.0.0.tar) && $(MOVE) `dirname .tmp/olric1.0.0`/olric1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/olric1.0.0
