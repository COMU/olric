...
# Generated by qmake (2.01a) (Qt 4.4.3) on: Çar Oca 21 14:51:20 2009
# Project:  olric.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/olric1.0.0/ && $(COPY_FILE) --parents src/client.h src/AnaPencere.h tool.h .tmp/olric1.0.0/ && $(COPY_FILE) --parents resources/source.qrc .tmp/olric1.0.0/ && $(COPY_FILE) --parents src/client.cpp qtc-gdbmacros/gdbmacros.cpp src/AnaPencere.cpp src/main.cpp tool.cpp .tmp/olric1.0.0/ && $(COPY_FILE) --parents ui/anapencere.ui .tmp/olric1.0.0/ && $(COPY_FILE) --parents resources/olric_tr_TR.ts .tmp/olric1.0.0/ && (cd `dirname .tmp/olric1.0.0` && $(TAR) olric1.0.0.tar olric1.0.0 && $(COMPRESS) olric1.0.0.tar) && $(MOVE) `dirname .tmp/olric1.0.0`/olric1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/olric1.0.0
